...
<body>
  ...
  <div class="button-container">
    <button class="my-button" onclick="startNewProject()">START A NEW PROJECT</button>
    <button class="my-button" onclick=viewExistingProjects()>VIEW EXISTING PROJECTS</button>
  </div>
  <script>
    function startNewProject() {
      window.location.href = 'newpro.php'; // Change the file extension to .php
    }
